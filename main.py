...
def main_config_run(    
    ...
    if eval_mode == "nested_cv" or eval_mode == "optuna":
        ...
        for outer_idx, data_config in enumerate(data_configs):
            ...
            if eval_mode == "nested_cv":
                ...
                for idx, config in enumerate(tqdm(configs)):
                    ...
                    if score < best_eval_score:
                        ...
                        if "best_val_required_conformal_p" in mean_metrics:
                            required_conformity = mean_metrics["best_val_required_conformal_p"]
            ...
            best_config["training_hyperparameters"]["conformal_p"] = required_conformity
            print(best_config)
